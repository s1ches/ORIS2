...
namespace TeamHost.Persistence.Migrations
{
    ...
    [Migration("20240413074033_AddChatsAndMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamHost.Domain.Entities.Chats.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SenderUserInfoId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TeamHost.Domain.Entities.Chats.Chat", b =>
                {
                    b.HasOne("TeamHost.Domain.Entities.StaticFile", "ChatImage")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamHost.Domain.Entities.Chats.Message", b =>
                {
                    ...
                    b.HasOne("TeamHost.Domain.Entities.UserInfo", "SenderUserInfo")
                        .WithMany()
                        .HasForeignKey("SenderUserInfoId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
